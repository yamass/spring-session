...
public final class SessionRepositoryMessageInterceptor<S extends ExpiringSession> extends ChannelInterceptorAdapter
    ...
    static final String SESSION_ATTR = "httpSession.id";
    ...
    public void afterConnectionEstablished(WebSocketSession session)
            throws Exception {
        delegateHandler.afterConnectionEstablished(session);
    }
    ...
    public void handleMessage(WebSocketSession session,
        ...
        delegateHandler.handleMessage(session, message);
    }
    ...
    public void handleTransportError(WebSocketSession session,
        ...
        delegateHandler.handleTransportError(session, exception);
    }
    ...
    public void afterConnectionClosed(WebSocketSession session,
        ...
        delegateHandler.afterConnectionClosed(session, closeStatus);
    }



    public boolean supportsPartialMessages() {
        return delegateHandler.supportsPartialMessages();
    }
    ...
    public Message<?> preSend(Message<?> message, MessageChannel channel) {
        ...
        String sessionId = sessionHeaders == null ? null : (String) sessionHeaders.get(SESSION_ATTR);
        if (sessionId != null) {
            S session = sessionRepository.getSession(sessionId);
            if (session == null) {
                // temporary until SPR-12288 resolved
                throw new SessionLimitExceededException("Session Expired", CloseStatus.SESSION_NOT_RELIABLE);
            } else {
