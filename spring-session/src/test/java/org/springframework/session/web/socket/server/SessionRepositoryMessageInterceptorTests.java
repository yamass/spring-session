...
public class SessionRepositoryMessageInterceptorTests {
    ...
    public void setMatchingMessageTypesEmpty() {
        interceptor.setMatchingMessageTypes(Collections.emptySet());
    }
    ...
    public void beforeHandshakeSession() throws Exception {
        ...
        assertThat(attributes.get(SessionRepositoryMessageInterceptor.SESSION_ATTR)).isEqualTo(httpSession.getId());
    }
    ...
    private void setSessionId(String id) {
        headers.getSessionAttributes().put(SessionRepositoryMessageInterceptor.SESSION_ATTR, id);
    }
